...
Крім того, npm run чудовий ще й тому, що npm автоматично додає в $ PATH директорію node_modules / .bin, так що ви можете безпосередньо запускати команди з dependencies або devDependencies, без необхідності встановлювати це модулі глобально. npm-пакети, які ви хотіли б включити в свій воркфлоу, повинні мати всього лише простий інтерфейс командного рядка, і ви зможете написати просту автоматизацію самостійно.
